      ...
      <div className="container mx-auto flex items-center justify-between py-4 px-4 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {user ? (
            ...
            <Link
              to="/login"
              className="font-body text-sm border border-primary text-primary px-4 py-2 rounded-md hover:bg-primary hover:text-primary-foreground transition-colors"
            >
              Войти
            </Link>
          )}
          ...
          >
            <nav className="flex flex-col p-4 gap-4">
              ...
              {user ? (
                ...
                <Link to="/login" onClick={() => setIsOpen(false)} className="font-body text-left py-2 text-primary hover:opacity-80 transition-colors">
                  Войти
                </Link>
              )}
            </nav>
