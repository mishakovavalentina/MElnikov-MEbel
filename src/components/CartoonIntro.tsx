  ...
  return (
    <div className="w-full overflow-hidden rounded-xl shadow-card">
      <svg viewBox="0 0 960 540" className="w-full h-auto block" role="img" aria-label="Мультзаставка: Юра-Северянин">
        ...
        {/* угольный разрез справа — стоит на земле (основание уходит под передний план) */}
        <path d="M640 480 L720 402 L960 402 L960 480 Z" fill="#5D4037" />
        <path d="M780 480 L840 442 L960 442 L960 480 Z" fill="#4E342E" />
        <DumpTruck x={740} y={394} s={0.85} />
        <DumpTruck x={866} y={434} s={0.95} />
