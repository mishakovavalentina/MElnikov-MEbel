...
### Правила по стилям
- Дизайн-система проекта (цвета, шрифты, отступы, состояния кнопок) описана в [DESIGN.md](./DESIGN.md) — при любых UI-правках сверяться с ним; живая витрина — страница `/design-system`
